...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    console.log("%cGitHub.com/%c" + "LoliPix/ACG-Home", "padding: 5px; border-radius: 6px 0 0 6px; background-color: #010101; color: #ffffff;", "padding: 5px; border-radius: 0 6px 6px 0; background-color: #ff9901; color: #ffffff;");
    console.groupEnd();
    ...
    // 球球你别改这里可以嘛呜呜呜 (＞﹏＜)
    if (config.content.masterInfo.name === "LoliPix") {
